...
/**
 * This class stands for updateOrderRequest StructType
 * @subpackage Structs
 */
class UpdateOrderRequest extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    public $products;
    /**
     * Constructor method for updateOrderRequest
     * @uses UpdateOrderRequest::setHash()
     * @uses UpdateOrderRequest::setWebshop()
     * @uses UpdateOrderRequest::setTargetWebshop()
     * @uses UpdateOrderRequest::setOrderReference()
     * @uses UpdateOrderRequest::setProducts()
     * @param string $hash
     * @param int $webshop
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\UpdateOrderRequest
     */
