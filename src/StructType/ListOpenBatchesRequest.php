...
/**
 * This class stands for listOpenBatchesRequest StructType
 * @subpackage Structs
 */
class ListOpenBatchesRequest extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    /**
     * Constructor method for listOpenBatchesRequest
     * @uses ListOpenBatchesRequest::setHash()
     * @uses ListOpenBatchesRequest::setWebshop()
     * @uses ListOpenBatchesRequest::setTargetWebshop()
     * @param string $hash
     * @param int $webshop
     * @param int $targetWebshop
     */
    public function __construct($hash = null, $webshop = null, $targetWebshop = null)
    {
        $this
            ->setHash($hash)
            ->setWebshop($webshop)
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\ListOpenBatchesRequest
     */
