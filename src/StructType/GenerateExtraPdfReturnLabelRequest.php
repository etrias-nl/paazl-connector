...
/**
 * This class stands for generateExtraPdfReturnLabelRequest StructType
 * @subpackage Structs
 */
class GenerateExtraPdfReturnLabelRequest extends GenerateReturnLabelType
{
    /**
     * The printer
    ...
    public $printer;
    /**
     * Constructor method for generateExtraPdfReturnLabelRequest
     * @uses GenerateExtraPdfReturnLabelRequest::setPrinter()
     ...
     * @param string $printer
     * @return \Etrias\PaazlConnector\StructType\GenerateExtraPdfReturnLabelRequest
     */
