...
/**
 * This class stands for generateLabelsResponse StructType
 * @subpackage Structs
 */
class GenerateLabelsResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $metaData;
    /**
     * Constructor method for generateLabelsResponse
     * @uses GenerateLabelsResponse::setError()
     * @uses GenerateLabelsResponse::setLabels()
     * @uses GenerateLabelsResponse::setMetaData()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GenerateLabelsResponse
     */
    ...
    {
        foreach ($metaData as $generateLabelsResponseMetaDataItem) {
            // validation for constraint: itemType
            if (!$generateLabelsResponseMetaDataItem instanceof \Etrias\PaazlConnector\StructType\LabelMetaDataType) {
                throw new \InvalidArgumentException(sprintf('The metaData property can only contain items of \Etrias\PaazlConnector\StructType\LabelMetaDataType, "%s" given', is_object($generateLabelsResponseMetaDataItem) ? get_class($generateLabelsResponseMetaDataItem) : gettype($generateLabelsResponseMetaDataItem)), __LINE__);
            }
        }
