...
/**
 * This class stands for getExistingZplLabelRequest StructType
 * @subpackage Structs
 */
class GetExistingZplLabelRequest extends GetExistingLabelType
{
    /**
     * The printer
    ...
    public $printer;
    /**
     * Constructor method for getExistingZplLabelRequest
     * @uses GetExistingZplLabelRequest::setPrinter()
     ...
     * @param string $printer
     * @return \Etrias\PaazlConnector\StructType\GetExistingZplLabelRequest
     */
