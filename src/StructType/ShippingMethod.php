...
/**
 * This class stands for shippingMethod StructType
 * @subpackage Structs
 */
class ShippingMethod extends AbstractStructBase
{
    /**
     * The type
     * @var string
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \Etrias\PaazlConnector\StructType\ReturnContractType
     */
    ...
    public $description;
    /**
     * Constructor method for shippingMethod
     * @uses ShippingMethod::setType()
     * @uses ShippingMethod::setDistributor()
     * @uses ShippingMethod::setContract()
     * @uses ShippingMethod::setIdentifier()
     * @uses ShippingMethod::setOption()
     * @uses ShippingMethod::setReturnContract()
     * @uses ShippingMethod::setServicepointAccountNumber()
     * @uses ShippingMethod::setServicepointNotificationEmail()
     * @uses ShippingMethod::setServicepointNotificationMobile()
     * @uses ShippingMethod::setPrice()
     * @uses ShippingMethod::setShippingPaymentType()
     * @uses ShippingMethod::setBillingAccountNumber()
     * @uses ShippingMethod::setInvoiceNumber()
     * @uses ShippingMethod::setPackagingWeight()
     * @uses ShippingMethod::setCustomsValue()
     * @uses ShippingMethod::setCustomsValueCurrency()
     * @uses ShippingMethod::setDutiesPaymentType()
     * @uses ShippingMethod::setDutiesAccountNumber()
     * @uses ShippingMethod::setOrderWeight()
     * @uses ShippingMethod::setAssuredAmount()
     * @uses ShippingMethod::setAssuredAmountCurrency()
     * @uses ShippingMethod::setCollo()
     * @uses ShippingMethod::setPackageCount()
     * @uses ShippingMethod::setMaxLabels()
     * @uses ShippingMethod::setPackagingType()
     * @uses ShippingMethod::setPreferredDeliveryDate()
     * @uses ShippingMethod::setPreferredDateChosen()
     * @uses ShippingMethod::setDescription()
     * @param string $type
     * @param string $distributor
     * @param string $contract
     * @param string $identifier
     * @param string $option
     * @param \Etrias\PaazlConnector\StructType\ReturnContractType $returnContract
    ...
    public function __construct($type = null, $distributor = null, $contract = null, $identifier = null, $option = null, \Etrias\PaazlConnector\StructType\ReturnContractType $returnContract = null, $servicepointAccountNumber = null, $servicepointNotificationEmail = null, $servicepointNotificationMobile = null, $price = null, $shippingPaymentType = null, $billingAccountNumber = null, $invoiceNumber = null, $packagingWeight = null, $customsValue = null, $customsValueCurrency = 'EUR', $dutiesPaymentType = null, $dutiesAccountNumber = null, $orderWeight = null, $assuredAmount = null, $assuredAmountCurrency = 'EUR', $collo = null, $packageCount = null, $maxLabels = null, $packagingType = null, $preferredDeliveryDate = null, $preferredDateChosen = false, $description = null)
    {
        $this
            ...
            ->setOption($option)
            ->setReturnContract($returnContract)
     ...
     * @param string $type
     * @return \Etrias\PaazlConnector\StructType\ShippingMethod
     */
    ...
    /**
     * Get returnContract value
     * @return \Etrias\PaazlConnector\StructType\ReturnContractType|null
     */
    ...
    /**
     * Set returnContract value
     * @param \Etrias\PaazlConnector\StructType\ReturnContractType $returnContract
     * @return \Etrias\PaazlConnector\StructType\ShippingMethod
     */
    public function setReturnContract(\Etrias\PaazlConnector\StructType\ReturnContractType $returnContract = null)
    {
