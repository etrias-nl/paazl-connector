...
/**
 * This class stands for getExistingZplLabelsResponse StructType
 * @subpackage Structs
 */
class GetExistingZplLabelsResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $metaData;
    /**
     * Constructor method for getExistingZplLabelsResponse
     * @uses GetExistingZplLabelsResponse::setError()
     * @uses GetExistingZplLabelsResponse::setLabels()
     * @uses GetExistingZplLabelsResponse::setMetaData()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GetExistingZplLabelsResponse
     */
    ...
    {
        foreach ($metaData as $getExistingZplLabelsResponseMetaDataItem) {
            // validation for constraint: itemType
            if (!$getExistingZplLabelsResponseMetaDataItem instanceof \Etrias\PaazlConnector\StructType\LabelMetaDataType) {
                throw new \InvalidArgumentException(sprintf('The metaData property can only contain items of \Etrias\PaazlConnector\StructType\LabelMetaDataType, "%s" given', is_object($getExistingZplLabelsResponseMetaDataItem) ? get_class($getExistingZplLabelsResponseMetaDataItem) : gettype($getExistingZplLabelsResponseMetaDataItem)), __LINE__);
            }
        }
