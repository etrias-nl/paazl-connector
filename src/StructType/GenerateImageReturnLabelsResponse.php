...
/**
 * This class stands for generateImageReturnLabelsResponse StructType
 * @subpackage Structs
 */
class GenerateImageReturnLabelsResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $label;
    /**
     * Constructor method for generateImageReturnLabelsResponse
     * @uses GenerateImageReturnLabelsResponse::setError()
     * @uses GenerateImageReturnLabelsResponse::setLabel()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GenerateImageReturnLabelsResponse
     */
    ...
    {
        foreach ($label as $generateImageReturnLabelsResponseLabelItem) {
            // validation for constraint: itemType
            if (!$generateImageReturnLabelsResponseLabelItem instanceof \Etrias\PaazlConnector\StructType\ReturnLabelType) {
                throw new \InvalidArgumentException(sprintf('The label property can only contain items of \Etrias\PaazlConnector\StructType\ReturnLabelType, "%s" given', is_object($generateImageReturnLabelsResponseLabelItem) ? get_class($generateImageReturnLabelsResponseLabelItem) : gettype($generateImageReturnLabelsResponseLabelItem)), __LINE__);
            }
        }
        $this->label = $label;
        return $this;
