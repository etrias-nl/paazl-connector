...
/**
 * This class stands for getExistingPdfLabelsResponse StructType
 * @subpackage Structs
 */
class GetExistingPdfLabelsResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $metaData;
    /**
     * Constructor method for getExistingPdfLabelsResponse
     * @uses GetExistingPdfLabelsResponse::setError()
     * @uses GetExistingPdfLabelsResponse::setLabels()
     * @uses GetExistingPdfLabelsResponse::setMetaData()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GetExistingPdfLabelsResponse
     */
    ...
    {
        foreach ($metaData as $getExistingPdfLabelsResponseMetaDataItem) {
            // validation for constraint: itemType
            if (!$getExistingPdfLabelsResponseMetaDataItem instanceof \Etrias\PaazlConnector\StructType\LabelMetaDataType) {
                throw new \InvalidArgumentException(sprintf('The metaData property can only contain items of \Etrias\PaazlConnector\StructType\LabelMetaDataType, "%s" given', is_object($getExistingPdfLabelsResponseMetaDataItem) ? get_class($getExistingPdfLabelsResponseMetaDataItem) : gettype($getExistingPdfLabelsResponseMetaDataItem)), __LINE__);
            }
        }
