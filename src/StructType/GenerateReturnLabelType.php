...
/**
 * This class stands for generateReturnLabelType StructType
 * @subpackage Structs
 */
class GenerateReturnLabelType extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    /**
     * Constructor method for generateReturnLabelType
     * @uses GenerateReturnLabelType::setHash()
     * @uses GenerateReturnLabelType::setWebshop()
     * @uses GenerateReturnLabelType::setTargetWebshop()
     * @uses GenerateReturnLabelType::setOrderReference()
     * @uses GenerateReturnLabelType::setLabelProducts()
     * @uses GenerateReturnLabelType::setShippingOption()
     * @param string $hash
     * @param int $webshop
     ...
     */
    public function __construct($hash = null, $webshop = null, $targetWebshop = null, $orderReference = null, \Etrias\PaazlConnector\StructType\LabelProducts $labelProducts = null, $shippingOption = null)
    {
        $this
            ->setHash($hash)
            ->setWebshop($webshop)
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\GenerateReturnLabelType
     */
