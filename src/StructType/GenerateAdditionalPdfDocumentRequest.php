...
/**
 * This class stands for generateAdditionalPdfDocumentRequest StructType
 * @subpackage Structs
 */
class GenerateAdditionalPdfDocumentRequest extends GenerateAdditionalDocumentType
{
    ...
    public $printer;
    /**
     * Constructor method for generateAdditionalPdfDocumentRequest
     * @uses GenerateAdditionalPdfDocumentRequest::setPrinter()
     ...
     * @param string $printer
     * @return \Etrias\PaazlConnector\StructType\GenerateAdditionalPdfDocumentRequest
     */
