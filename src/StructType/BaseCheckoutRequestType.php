...
/**
 * This class stands for baseCheckoutRequestType StructType
 * @subpackage Structs
 */
class BaseCheckoutRequestType extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    /**
     * Constructor method for baseCheckoutRequestType
     * @uses BaseCheckoutRequestType::setHash()
     * @uses BaseCheckoutRequestType::setWebshop()
     * @uses BaseCheckoutRequestType::setTargetWebshop()
     * @uses BaseCheckoutRequestType::setOrderReference()
     * @param string $hash
     * @param int $webshop
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\BaseCheckoutRequestType
     */
