...
/**
 * This class stands for getExistingLabelType StructType
 * @subpackage Structs
 */
class GetExistingLabelType extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    /**
     * Constructor method for getExistingLabelType
     * @uses GetExistingLabelType::setHash()
     * @uses GetExistingLabelType::setWebshop()
     * @uses GetExistingLabelType::setTargetWebshop()
     * @uses GetExistingLabelType::setOrderReference()
     * @uses GetExistingLabelType::setBarcode()
     * @uses GetExistingLabelType::setIncludeMetaData()
     * @param string $hash
     * @param int $webshop
     ...
     */
    public function __construct($hash = null, $webshop = null, $targetWebshop = null, $orderReference = null, $barcode = null, $includeMetaData = null)
    {
        $this
            ->setHash($hash)
            ->setWebshop($webshop)
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\GetExistingLabelType
     */
