...
/**
 * This class stands for getExistingPdfLabelsRequest StructType
 * @subpackage Structs
 */
class GetExistingPdfLabelsRequest extends GetExistingLabelsType
{
    /**
     * The printer
    ...
    public $printer;
    /**
     * Constructor method for getExistingPdfLabelsRequest
     * @uses GetExistingPdfLabelsRequest::setPrinter()
     ...
     * @param string $printer
     * @return \Etrias\PaazlConnector\StructType\GetExistingPdfLabelsRequest
     */
