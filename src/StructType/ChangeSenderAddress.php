...
/**
 * This class stands for changeSenderAddress StructType
 * @subpackage Structs
 */
class ChangeSenderAddress extends AbstractStructBase
{
    /**
     * The addresseeLine
    ...
    /**
     * Constructor method for changeSenderAddress
     * @uses ChangeSenderAddress::setAddresseeLine()
     * @uses ChangeSenderAddress::setStreet()
     * @uses ChangeSenderAddress::setHousenumber()
     * @uses ChangeSenderAddress::setAddition()
     * @uses ChangeSenderAddress::setZipcode()
     * @uses ChangeSenderAddress::setCity()
     * @uses ChangeSenderAddress::setProvince()
     * @uses ChangeSenderAddress::setCountry()
     * @uses ChangeSenderAddress::setAdditionalAddressLine()
     ...
     * @param string $addresseeLine
     * @return \Etrias\PaazlConnector\StructType\ChangeSenderAddress
     */
    ...
    {
        foreach ($additionalAddressLine as $changeSenderAddressAdditionalAddressLineItem) {
            // validation for constraint: itemType
            if (!is_string($changeSenderAddressAdditionalAddressLineItem)) {
                throw new \InvalidArgumentException(sprintf('The additionalAddressLine property can only contain items of string, "%s" given', is_object($changeSenderAddressAdditionalAddressLineItem) ? get_class($changeSenderAddressAdditionalAddressLineItem) : gettype($changeSenderAddressAdditionalAddressLineItem)), __LINE__);
            }
        }
