...
/**
 * This class stands for generateExtraPdfReturnLabelResponse StructType
 * @subpackage Structs
 */
class GenerateExtraPdfReturnLabelResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $label;
    /**
     * Constructor method for generateExtraPdfReturnLabelResponse
     * @uses GenerateExtraPdfReturnLabelResponse::setError()
     * @uses GenerateExtraPdfReturnLabelResponse::setLabel()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GenerateExtraPdfReturnLabelResponse
     */
