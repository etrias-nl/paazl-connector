...
/**
 * This class stands for validateOrderResponseType StructType
 * @subpackage Structs
 */
class ValidateOrderResponseType extends AbstractStructBase
{
    /**
     * The error
    ...
    public $succes;
    /**
     * Constructor method for validateOrderResponseType
     * @uses ValidateOrderResponseType::setError()
     * @uses ValidateOrderResponseType::setSucces()
