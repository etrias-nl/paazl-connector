...
/**
 * This class stands for getExistingPdfLabelRequest StructType
 * @subpackage Structs
 */
class GetExistingPdfLabelRequest extends GetExistingLabelType
{
    /**
     * The printer
    ...
    public $printer;
    /**
     * Constructor method for getExistingPdfLabelRequest
     * @uses GetExistingPdfLabelRequest::setPrinter()
     ...
     * @param string $printer
     * @return \Etrias\PaazlConnector\StructType\GetExistingPdfLabelRequest
     */
