...
/**
 * This class stands for getExistingZplLabelResponse StructType
 * @subpackage Structs
 */
class GetExistingZplLabelResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $metaData;
    /**
     * Constructor method for getExistingZplLabelResponse
     * @uses GetExistingZplLabelResponse::setError()
     * @uses GetExistingZplLabelResponse::setLabel()
     * @uses GetExistingZplLabelResponse::setMetaData()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GetExistingZplLabelResponse
     */
