...
/**
 * This class stands for orderDetailsRequest StructType
 * @subpackage Structs
 */
class OrderDetailsRequest extends AbstractStructBase
{
    /**
     * The hash
     * @var string
     ...
     * @uses OrderDetailsRequest::setHash()
     * @uses OrderDetailsRequest::setWebshop()
     * @uses OrderDetailsRequest::setTargetWebshop()
     * @uses OrderDetailsRequest::setOrderReference()
     * @uses OrderDetailsRequest::setExtendedDetails()
     * @param string $hash
     * @param int $webshop
     ...
     */
    public function __construct($hash = null, $webshop = null, $targetWebshop = null, $orderReference = null, $extendedDetails = null)
    {
        $this
            ->setHash($hash)
            ->setWebshop($webshop)
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\OrderDetailsRequest
     */
    ...
    public function setExtendedDetails($extendedDetails = null)
    {
        ...
        if (!is_null($extendedDetails) && !is_bool($extendedDetails)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a bool, "%s" given', gettype($extendedDetails)), __LINE__);
        }
