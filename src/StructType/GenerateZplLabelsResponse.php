...
/**
 * This class stands for generateZplLabelsResponse StructType
 * @subpackage Structs
 */
class GenerateZplLabelsResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $metaData;
    /**
     * Constructor method for generateZplLabelsResponse
     * @uses GenerateZplLabelsResponse::setError()
     * @uses GenerateZplLabelsResponse::setLabels()
     * @uses GenerateZplLabelsResponse::setMetaData()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GenerateZplLabelsResponse
     */
    ...
    {
        foreach ($metaData as $generateZplLabelsResponseMetaDataItem) {
            // validation for constraint: itemType
            if (!$generateZplLabelsResponseMetaDataItem instanceof \Etrias\PaazlConnector\StructType\LabelMetaDataType) {
                throw new \InvalidArgumentException(sprintf('The metaData property can only contain items of \Etrias\PaazlConnector\StructType\LabelMetaDataType, "%s" given', is_object($generateZplLabelsResponseMetaDataItem) ? get_class($generateZplLabelsResponseMetaDataItem) : gettype($generateZplLabelsResponseMetaDataItem)), __LINE__);
            }
        }
