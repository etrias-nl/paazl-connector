...
/**
 * This class stands for generateExtraImageLabelResponse StructType
 * @subpackage Structs
 */
class GenerateExtraImageLabelResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $metaData;
    /**
     * Constructor method for generateExtraImageLabelResponse
     * @uses GenerateExtraImageLabelResponse::setError()
     * @uses GenerateExtraImageLabelResponse::setLabel()
     * @uses GenerateExtraImageLabelResponse::setMetaData()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GenerateExtraImageLabelResponse
     */
    ...
    {
        foreach ($label as $generateExtraImageLabelResponseLabelItem) {
            // validation for constraint: itemType
            if (!$generateExtraImageLabelResponseLabelItem instanceof \Etrias\PaazlConnector\StructType\LabelType) {
                throw new \InvalidArgumentException(sprintf('The label property can only contain items of \Etrias\PaazlConnector\StructType\LabelType, "%s" given', is_object($generateExtraImageLabelResponseLabelItem) ? get_class($generateExtraImageLabelResponseLabelItem) : gettype($generateExtraImageLabelResponseLabelItem)), __LINE__);
            }
        }
        $this->label = $label;
        return $this;
    ...
    {
        foreach ($metaData as $generateExtraImageLabelResponseMetaDataItem) {
            // validation for constraint: itemType
            if (!$generateExtraImageLabelResponseMetaDataItem instanceof \Etrias\PaazlConnector\StructType\LabelMetaDataType) {
                throw new \InvalidArgumentException(sprintf('The metaData property can only contain items of \Etrias\PaazlConnector\StructType\LabelMetaDataType, "%s" given', is_object($generateExtraImageLabelResponseMetaDataItem) ? get_class($generateExtraImageLabelResponseMetaDataItem) : gettype($generateExtraImageLabelResponseMetaDataItem)), __LINE__);
            }
        }
