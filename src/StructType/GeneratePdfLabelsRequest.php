...
/**
 * This class stands for generatePdfLabelsRequest StructType
 * @subpackage Structs
 */
class GeneratePdfLabelsRequest extends AbstractStructBase
{
    /**
     * The webshop
     * @var int
    ...
    /**
     * Constructor method for generatePdfLabelsRequest
     * @uses GeneratePdfLabelsRequest::setWebshop()
     * @uses GeneratePdfLabelsRequest::setPrinter()
     * @uses GeneratePdfLabelsRequest::setOrder()
     * @uses GeneratePdfLabelsRequest::setIncludeMetaData()
     * @param int $webshop
     ...
     * Set webshop value
     * @param int $webshop
     * @return \Etrias\PaazlConnector\StructType\GeneratePdfLabelsRequest
     */
    ...
    {
        foreach ($order as $generatePdfLabelsRequestOrderItem) {
            // validation for constraint: itemType
            if (!$generatePdfLabelsRequestOrderItem instanceof \Etrias\PaazlConnector\StructType\OrderType) {
                throw new \InvalidArgumentException(sprintf('The order property can only contain items of \Etrias\PaazlConnector\StructType\OrderType, "%s" given', is_object($generatePdfLabelsRequestOrderItem) ? get_class($generatePdfLabelsRequestOrderItem) : gettype($generatePdfLabelsRequestOrderItem)), __LINE__);
            }
        }
        $this->order = $order;
        return $this;
