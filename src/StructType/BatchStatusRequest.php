...
/**
 * This class stands for batchStatusRequest StructType
 * @subpackage Structs
 */
class BatchStatusRequest extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    public $batch;
    /**
     * Constructor method for batchStatusRequest
     * @uses BatchStatusRequest::setHash()
     * @uses BatchStatusRequest::setWebshop()
     * @uses BatchStatusRequest::setTargetWebshop()
     * @uses BatchStatusRequest::setBatch()
     * @param string $hash
     * @param int $webshop
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\BatchStatusRequest
     */
