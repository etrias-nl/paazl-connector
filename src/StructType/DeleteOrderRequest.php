...
class DeleteOrderRequest extends AbstractStructBase
{
     ...
     * @uses DeleteOrderRequest::setHash()
     * @uses DeleteOrderRequest::setWebshop()
     * @uses DeleteOrderRequest::setTargetWebshop()
     * @uses DeleteOrderRequest::setOrderReference()
     * @param string $hash
     * @param int $webshop
     * @param int $targetWebshop
     * @param string $orderReference
     */
    public function __construct($hash = null, $webshop = null, $targetWebshop = null, $orderReference = null)
    {
        $this
            ->setHash($hash)
            ->setWebshop($webshop)
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\DeleteOrderRequest
     */
