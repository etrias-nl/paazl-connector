...
/**
 * This class stands for generateAdditionalDocumentType StructType
 * @subpackage Structs
 */
class GenerateAdditionalDocumentType extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    public $documentType;
    /**
     * Constructor method for generateAdditionalDocumentType
     * @uses GenerateAdditionalDocumentType::setHash()
     * @uses GenerateAdditionalDocumentType::setWebshop()
     * @uses GenerateAdditionalDocumentType::setTargetWebshop()
     * @uses GenerateAdditionalDocumentType::setOrderReference()
     * @uses GenerateAdditionalDocumentType::setBarcode()
     * @uses GenerateAdditionalDocumentType::setDocumentType()
     * @param string $hash
     * @param int $webshop
     ...
     */
    public function __construct($hash = null, $webshop = null, $targetWebshop = null, $orderReference = null, $barcode = null, $documentType = null)
    {
        $this
            ->setHash($hash)
            ->setWebshop($webshop)
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\GenerateAdditionalDocumentType
     */
