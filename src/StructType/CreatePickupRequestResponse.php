...
/**
 * This class stands for createPickupRequestResponse StructType
 * @subpackage Structs
 */
class CreatePickupRequestResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $success;
    /**
     * Constructor method for createPickupRequestResponse
     * @uses CreatePickupRequestResponse::setError()
     * @uses CreatePickupRequestResponse::setSuccess()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\CreatePickupRequestResponse
     */
