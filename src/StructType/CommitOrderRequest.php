...
/**
 * This class stands for commitOrderRequest StructType
 * @subpackage Structs
 */
class CommitOrderRequest extends AbstractStructBase
{
    /**
     * The hash
     * @var string
    ...
    /**
     * Constructor method for commitOrderRequest
     * @uses CommitOrderRequest::setHash()
     * @uses CommitOrderRequest::setWebshop()
     * @uses CommitOrderRequest::setTargetWebshop()
     * @uses CommitOrderRequest::setOrderReference()
     * @uses CommitOrderRequest::setPendingOrderReference()
     * @uses CommitOrderRequest::setTotalAmount()
     * @uses CommitOrderRequest::setTotalAmountCurrency()
     * @uses CommitOrderRequest::setLanguage()
     * @uses CommitOrderRequest::setCustomerEmail()
     * @uses CommitOrderRequest::setCustomerPhoneNumber()
     * @uses CommitOrderRequest::setShippingMethod()
     * @uses CommitOrderRequest::setShipperAddress()
     * @uses CommitOrderRequest::setReturnAddress()
     * @uses CommitOrderRequest::setShippingAddress()
     * @param string $hash
     * @param int $webshop
     ...
     * Set hash value
     * @param string $hash
     * @return \Etrias\PaazlConnector\StructType\CommitOrderRequest
     */
