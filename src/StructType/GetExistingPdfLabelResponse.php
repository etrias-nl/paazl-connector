...
/**
 * This class stands for getExistingPdfLabelResponse StructType
 * @subpackage Structs
 */
class GetExistingPdfLabelResponse extends AbstractStructBase
{
    /**
     * The error
    ...
    public $metaData;
    /**
     * Constructor method for getExistingPdfLabelResponse
     * @uses GetExistingPdfLabelResponse::setError()
     * @uses GetExistingPdfLabelResponse::setLabel()
     * @uses GetExistingPdfLabelResponse::setMetaData()
     ...
     * Set error value
     * @param \Etrias\PaazlConnector\StructType\ErrorType $error
     * @return \Etrias\PaazlConnector\StructType\GetExistingPdfLabelResponse
     */
